      ...
      <div class="col-12 xl:col-6"
        ...
        <div class="h-full w-full m-0 py-7 px-4"
          ...
          <div class="w-full md:w-10 mx-auto">
            <label for="email1" class="block text-900 text-xl font-medium mb-2">包装厂名称</label>
...
export default {
  ...
  methods:{
    submit(){
      ...
      axios.post('http://182.92.99.82:8081/fsims/admin/addpackhouse', qs.stringify({name, address, state, legal_person}),{
        headers: {
