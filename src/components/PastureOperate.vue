            ...
            <div class="grid">
                <div class="col-12">
                    <div class="grid">
                        <div class="col-2 ">
                            <p v-if="lan == 'CN'"
                                style="font-size: xx-large;font-weight: bold;margin-top: 10%;;margin-left: 10%;">科尔沁牧场
                            </p>
                        ...
                        <div class="col-1 col-offset-3">
                            ...
                            <p v-else style="font-size: large;text-align: center;">A SlaughterHouse
                            </p>
                        </div>
                        <div class="col-1">
                            ...
                            <Column v-if="flag" field="state" header="状态">
                                <template #body="rowData">
                                    <div v-if="rowData.data.state === 0">
                                        <Button @click="handleButtonClick(rowData.data)" style="font-size: 12px; padding: 6px 10px;">确认接收</button>
                                    </div>
                                    <div v-else-if="rowData.data.state === 1">
                                        <div class="flex flex-wrap gap-2">
                                            <Tag class="mr-2" severity="success" :value="'已接收'" style="font-size: 12px; padding: 6px 10px;"></Tag>
                                        </div>
                                    </div>
                                </template>
                            </Column>
                ...
                <div class="col-12">
                    <div class="card" style="height: 40vh">
                        <DataTable :value="warehouse" scrollable scrollHeight="40vh" tableStyle="min-width: 50rem">
                            ...
                            <Column v-if="flag" field="state" header="状态"></Column>
                            <Column v-else field="state" header="state"></Column>
                        </DataTable>
                    </div>
                </div>
