...
export default {
    ...
    methods: {
        ...
        getHouse() {
            axios.get('http://182.92.99.82:8081/fsims/packoperator/searchhouse', { params: { uuid: this.uuid } }).then(res => {
        ...
        getReceive() {
            ...
            axios.get('http://182.92.99.82:8081/fsims/packoperator/receiverecords', { params: { house_number: house_number } }).then(res => {
        ...
        getBatch() {
            const house_number = localStorage.getItem('house_number')
            axios.get('http://182.92.99.82:8081/fsims/packoperator/batches', { params: { house_number: house_number } }).then(res => {
        ...
        confirmReceive(data) {
            ...
            axios.post('http://182.92.99.82:8081/fsims/packoperator/receiveconfirm', qs.stringify({ product_number }), {
                headers: {
        ...
        newPackBatch(data) {
            ...
            var product_number = data.product_number
            axios.post('http://182.92.99.82:8081/fsims/packoperator/newbatch', qs.stringify({ house_number, worker, pre_pid, product_number }), {
                headers: {
                    'Content-Type': 'application/x-www-form-urlencoded'
                }
            }).then(res => {
        ...
        newProduct() {
            ...
            axios.post('http://182.92.99.82:8081/fsims/packoperator/newproduct', qs.stringify({ batch_number, worker, house_number, type, shelf_life, pack_method, weight }), {
                headers: {
                    'Content-Type': 'application/x-www-form-urlencoded'
                }
            }).then(res => {
        ...
        EndPackage() {
            ...
            var worker = localStorage.getItem('account')
            var house_number = localStorage.getItem('house_number')
            axios.post('http://182.92.99.82:8081/fsims/packoperator/endbatch',
                qs.stringify({
                    batch_number,
                    worker,
                    house_number,
        ...
        getProducts() {
            const house_number = localStorage.getItem('house_number')
            axios.get('http://182.92.99.82:8081/fsims/packoperator/productsrecords', { params: { house_number: house_number } }).then(res => {
                console.log('warehouserecords:', res.data)
                this.productShow = res.data.data.records
            })
        },
        getVehicles() {
            axios.get('http://182.92.99.82:8081/fsims/packoperator/transportvehicles').then(res => {
                console.log('vehicles:', res.data.data.tvs)
                this.vehicles = res.data.data.tvs
            })
        },
        getMall() {
            axios.get('http://182.92.99.82:8081/fsims/packoperator/malls').then(res => {
        ...
        preTransport(){
            ...
            axios.post('http://182.92.99.82:8081/fsims/packoperator/pretransport', JSON.stringify(formData), {
                headers: {
        ...
        // getWarehouse() {
        //     const house_number = localStorage.getItem('house_number')
        //     axios.get('http://182.92.99.82:8081/fsims/packoperator/warehouserecords', { params: { house_number: house_number } }).then(res => {
        //         console.log('warehouserecords:', res.data)
