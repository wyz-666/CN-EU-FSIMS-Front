      ...
      <div class="col-12 xl:col-6"
        ...
        <div class="h-full w-full m-0 py-7 px-4"
          ...
          <div class="text-center mb-5">
            ...
            <div class="text-900 text-3xl font-medium mb-3">屠宰场管理</div>
            <span class="text-600 font-large">请添加</span>
          </div>

          <div class="w-full md:w-10 mx-auto">
            <label for="email1" class="block text-900 text-xl font-medium mb-2">屠宰场名称</label>
...
export default {
  ...
  methods:{
    submit(){
      ...
      axios.post('http://182.92.99.82:8081/fsims/admin/addslaughterhouse', qs.stringify({name, address, state, legal_person}),{
        headers: {
