      ...
      <div class="col-12 xl:col-6"
        ...
        <div class="h-full w-full m-0 py-7 px-4"
          ...
          <div class="text-center mb-5">
            ...
            <div class="text-900 text-3xl font-medium mb-3">包装厂员工管理</div>
            <span class="text-600 font-large">请添加</span>
          </div>

          <div class="w-full md:w-10 mx-auto">
            <label for="email1" class="block text-900 text-xl font-medium mb-2">员工姓名</label>
            ...
            <!--                            style="padding:1rem;" />-->
            <label for="selectType" class="block text-900 text-xl font-medium mb-2">请选择你所在的包装厂</label>
            <select id="selectType" v-model="selectedType" class="w-full mb-3" style="padding:1rem;">
              ...
              <option value="1">1 - 包装厂A</option>
              <option value="2">2 - 包装厂B</option>
              <option value="3">3 - 包装厂C</option>
            </select>
            <label for="phone" class="block text-900 text-xl font-medium mb-2">员工电话号码</label>
            <InputText id="phone" v-model="phone" type="text" class="w-full mb-3" placeholder="Phone"
                       style="padding:1rem;" />
