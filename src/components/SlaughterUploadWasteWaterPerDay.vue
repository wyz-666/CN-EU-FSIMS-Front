      ...
      <div class="col-12 xl:col-6"
        ...
        <div class="h-full w-full m-0 py-7 px-4"
          ...
          <div class="text-center mb-5">
            <div class="text-900 text-3xl font-medium mb-3">屠宰场当日废水处理</div>
  ...
  methods:{
    submit(){
      ...
      const jsonData = {
        ...
        req_slaughter_waste_water_per_day_3: parseFloat(this.overresidue),
        req_slaughter_waste_water_per_day_4: parseFloat(this.overresidueadd),
      }
      console.log(jsonData)
      axios.post('http://182.92.99.82:8081/fsims/slaughteroperator/upload/slaughterwastewater', JSON.stringify(jsonData),{
        headers: {
