<template>
	<div class="grid">
		...
		<div class="col-12 xl:col-8">
			<div class="card">
				<h5 v-if="lan == 'CN'">育肥厂情况</h5>
        <h5 v-else >Fattening plant situation</h5>
				<!-- <Button @click="toggleApplications" label="查看所有指标" /> -->
		...
		<div class="col-12 xl:col-4">
          ...
          <h5 v-else>Notification</h5>
            ...
            <span v-if="lan === 'CN'" class="text-700 line-height-3">
               B 牧场
              <span class="text-blue-500 font-medium">2500$</span>
              销售了
            </span>
            <span v-else class="text-700 line-height-3">
                Ranch B
                <span class="text-blue-500 font-medium">2500$</span>
                sold
            </span>
