            ...
            <div class="col-12 xl:col-6"
                ...
                <div class="h-full w-full m-0 py-7 px-4"
                    ...
                    <div class="text-center mb-5">
                        ...
                        <div v-else class="text-900 text-3xl font-medium mb-3">Food Safety Intelligent Management and Decision Support System</div>
                    ...
                    <div class="w-full md:w-10 mx-auto">
                        ...
                        <div>
                            <router-link to="/home">
                                <Button v-if="lan == 'CN'" label="登录" class="w-full p-3 text-xl"></button>
                                <Button v-else label="登录" class="w-full p-3 text-xl"></button>
                            </router-link>
                        </div>
