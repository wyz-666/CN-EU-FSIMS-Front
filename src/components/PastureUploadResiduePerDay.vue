      ...
      <div class="col-12 xl:col-6"
        ...
        <div class="h-full w-full m-0 py-7 px-4"
          ...
          <div class="text-center mb-5">
            <div class="text-900 text-3xl font-medium mb-3">牧场当日废渣处理</div>
  ...
  methods:{
    submit(){
      ...
      const jsonData = {
        ...
        pasture_waste_residue_per_day_1: parseFloat(this.residue),
        pasture_waste_residue_per_day_2: parseFloat(this.residueadd),
        pasture_waste_residue_per_day_3: parseFloat(this.overresidue),
        pasture_waste_residue_per_day_4: parseFloat(this.overresidueadd),
      }
      console.log(jsonData)
      axios.post('http://127.0.0.1:8080/fsims/pastureoperator/upload/pasturewasteresidue', JSON.stringify(jsonData),{
        headers: {
