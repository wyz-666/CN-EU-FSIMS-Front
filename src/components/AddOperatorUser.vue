      ...
      <div class="col-12 xl:col-6"
        ...
        <div class="h-full w-full m-0 py-7 px-4"
          ...
          <div class="text-center mb-5">
            ...
            <div class="text-900 text-3xl font-medium mb-3">屠宰场员工管理</div>
          ...
          <div class="w-full md:w-10 mx-auto">
            ...
            <!--                            style="padding:1rem;" />-->
            <label for="selectType" class="block text-900 text-xl font-medium mb-2">请选择你所在的屠宰场</label>
            <select id="selectType" v-model="selectedType" class="w-full mb-3" style="padding:1rem;">
              ...
              <option value="1">1 - 屠宰场A</option>
              <option value="2">2 - 屠宰场B</option>
              <option value="3">3 - 屠宰场C</option>
            </select>
