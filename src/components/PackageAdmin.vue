<template>
  ...
  <div class="card grid p-fluid larger-font">
    <div class="col-12 xl:col-4">
      <div class="flex align-items-center mb-2">
        <label for="packagename" class="mr-2">包装厂</label>
        <InputText id="packagename" v-model="packagename" placeholder="请输入包装厂名"></InputText>
      </div>
    </div>
    <div class="col-12 xl:col-4">
      <div class="flex align-items-center mb-2">
  ...
  <div class="card grid p-fluid">
    <div class="col-12 xl:col-4">
      <div class="flex align-items-center mb-2">
        <Button label="新增合作包装厂" icon="pi pi-plus" @click="addSlaughter"/>
      </div>
    </div>
    <div class="col-12 xl:col-4">
      <div class="flex align-items-center mb-2">
